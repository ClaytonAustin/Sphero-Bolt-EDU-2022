...
async function startProgram() {
	...
	setMainLed({ r: 255, g: 0, b: 0});
		for (var _i1 = 0; _i1 < 4; _i1++) {
			//loop this logic 4 times to create a square 
	...
	await Sound.Game.WinClassic.Play(true);*/
...
async function startProgram() {
	...
	/*Square 
	setHeading(270);
	await speak('hello triangle!', true);
	setMainLed({ r: 255, g: 0, b: 0});
		for (var _i1 = 0; _i1 < 3; _i1++) {
			//loop this logic 3 times to create a square 
			await Sound.Game.Coin.play(true);
			setMainLed({ r: 0, g: 255, b:0});
